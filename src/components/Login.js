...
const Login = () => {
  ...
  return (
    <div>
      ...
      <form className=" w-4/5  md:w-4/12 absolute left-0 right-0 top-20 bottom-20 m-auto p-12 bg-[#000000bf] text-white rounded-lg">
        ...
        <p
          className="text-stone-500 hover:text-stone-50"
